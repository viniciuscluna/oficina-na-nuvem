...
export const getMarcas = async (): Promise<Marca[]> =>
  ...
  export const getModelosByMarca = async (codigoMarca: string): Promise<ModeloResponse> =>
  (await instanceFipe.get<ModeloResponse>(`carros/marcas/${codigoMarca}/modelos`)).data;
